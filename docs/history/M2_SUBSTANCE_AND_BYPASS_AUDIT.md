...
`kubejs/server_scripts/30_integrations/02_process_ownership.js` точечно удаляет:
...
`kubejs/server_scripts/10_progression/02_ae2_epoch_gate.js` удаляет семь корневых рецептов:
