...
| Поле | Значение |
|---|---|
| Статус | Архитектура v1.2 — M0–M5 статически собраны (63 из 63 пунктов плана в [`registries/milestone_status.json`](registries/milestone_status.json)), пользовательские gate-прогоны ожидаются |
