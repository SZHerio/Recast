...
[`M9_IMPLEMENTATION_REPORT.md`](M9_IMPLEMENTATION_REPORT.md); статус билда и
порядок ручной проверки — в [`VERSION_LOG.md`](VERSION_LOG.md) и
[`M9_BUILD_TEST_PROTOCOL.md`](M9_BUILD_TEST_PROTOCOL.md). Исторические отчёты
...
[`M9_BUILD_TEST_PROTOCOL.md`](M9_BUILD_TEST_PROTOCOL.md). Подробный состав — в
[`M9_IMPLEMENTATION_REPORT.md`](M9_IMPLEMENTATION_REPORT.md).
...
[`registries/m10_release_readiness.json`](registries/m10_release_readiness.json),
реализация — [`M10_IMPLEMENTATION_REPORT.md`](M10_IMPLEMENTATION_REPORT.md),
пользовательский gate —
[`M10_BUILD_TEST_PROTOCOL.md`](M10_BUILD_TEST_PROTOCOL.md).
