...
//
// Контракт входа (05_ae2_entry_contract.js) открывает хранение и терминал в
...
ServerEvents.recipes((event) => {
  ...
  event.shaped('ae2:crafting_unit', [
    ...
    D: 'gtceu:hv_sensor'
  }).id('industrial_frontier:ae2_stage/crafting_unit')
  ...
  }).id('industrial_frontier:ae2_stage/molecular_assembler')
  ...
  event.shapeless('ae2:crafting_accelerator', [
    ...
    'gtceu:ev_emitter'
  ]).id('industrial_frontier:ae2_stage/crafting_accelerator')
