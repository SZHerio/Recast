...
ServerEvents.recipes((event) => {
  ...
  }).id('industrial_frontier:m5/ae2/charger')
  ...
  }).id('industrial_frontier:m5/ae2/inscriber')
  ...
  }).id('industrial_frontier:m5/ae2/energy_acceptor')
  ...
  }).id('industrial_frontier:m5/ae2/fluix_crystals')
  ...
  const processors = [
    ['industrial_frontier:m5/ae2/calculation_processor', 'ae2:printed_calculation_processor', 'ae2:calculation_processor'],
    ['industrial_frontier:m5/ae2/engineering_processor', 'ae2:printed_engineering_processor', 'ae2:engineering_processor'],
    ['industrial_frontier:m5/ae2/logic_processor', 'ae2:printed_logic_processor', 'ae2:logic_processor']
  ]
