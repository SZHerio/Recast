...
ServerEvents.recipes((event) => {
  ...
  }).id('industrial_frontier:m7/creating_space/rocket_engineer_table')
  ...
  }).id('industrial_frontier:m7/creating_space/rocket_casing')
  ...
  event.shaped('creatingspace:rocket_controls', [
    ...
    C: 'create:controls',
    T: 'gtceu:titanium_plate'
  }).id('industrial_frontier:m7/creating_space/rocket_controls')
  ...
  }).id('industrial_frontier:m7/creating_space/rocket_generator')
  ...
  }).id('industrial_frontier:m7/creating_space/air_liquefier')
  ...
  event.shaped('creatingspace:mechanical_electrolyzer', [
    ...
    H: 'gtceu:ev_machine_hull'
  }).id('industrial_frontier:m7/creating_space/mechanical_electrolyzer')
  ...
  event.shaped('creatingspace:cryogenic_tank', [
    ...
    K: 'create:fluid_tank'
  }).id('industrial_frontier:m7/creating_space/cryogenic_tank')
  ...
  event.shaped('creatingspace:oxygen_sealer', [
    ...
    P: 'gtceu:ev_electric_pump'
  }).id('industrial_frontier:m7/creating_space/oxygen_sealer')
