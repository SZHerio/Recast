...
ServerEvents.recipes((event) => {
  ...
  }).id('industrial_frontier:m6/nuclearcraft/manufactory')
  ...
  event.shaped('nuclearcraft:alloy_smelter', [
    ...
    D: 'gtceu:hv_machine_hull'
  }).id('industrial_frontier:m6/nuclearcraft/alloy_smelter')
  ...
  }).id('industrial_frontier:m6/nuclearcraft/fission_reactor_controller')
