...
ServerEvents.recipes((event) => {
  ...
  event.shaped('nuclearcraft:linear_accelerator_controller', [
    ...
    S: 'gtceu:iv_sensor'
  }).id('industrial_frontier:nuclearcraft/linear_accelerator')
  ...
  event.recipes.gtceu.centrifuge('industrial_frontier:isotopes/calcium_48_source_batch')
  ...
  event.shaped('nuclearcraft:ring_accelerator_controller', [
    ...
    F: 'nuclearcraft:accelerator_casing',
    S: 'gtceu:iv_emitter'
  }).id('industrial_frontier:nuclearcraft/ring_accelerator')
  ...
  }).id('industrial_frontier:nuclearcraft/beam_diverter')
  ...
  }).id('industrial_frontier:nuclearcraft/target_chamber')
  ...
  }).id('industrial_frontier:nuclearcraft/collision_chamber')
  ...
  event.shaped('nuclearcraft:chamber_terminal', [
    ...
    S: 'gtceu:iv_sensor'
  }).id('industrial_frontier:nuclearcraft/chamber_terminal')
  ...
  }).id('industrial_frontier:nuclearcraft/quantum_transformer')
