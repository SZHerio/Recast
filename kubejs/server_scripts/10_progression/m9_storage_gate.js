...
//
//   P2 — терминал, коннектор и кабели. Сортировка сундуков к этому времени
//        отнимает больше времени, чем плавка.
...
// которым сборка относится иначе; вместо них идут сталь, медь и схемы своей
// эпохи, то есть то, что игрок к этому моменту действительно производит.
