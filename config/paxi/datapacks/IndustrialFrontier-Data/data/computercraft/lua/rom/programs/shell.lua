...
local function executeProgram(remainingRecursion, path, args)
    ...
    if contents:sub(1, 2) == "#!" then
        ...
        if remainingRecursion == 0 then
            printError("\207\240\229\226\251\248\229\237\224 \227\235\243\225\232\237\224 \240\229\234\243\240\241\232\232 hashbang \239\240\232 \231\224\227\240\243\231\234\229 \244\224\233\235\224: " .. path)
            return false
        end
        ...
        if not resolvedHashbangProgram then
            printError("\207\240\238\227\240\224\236\236\224 \232\231 hashbang \237\229 \237\224\233\228\229\237\224: " .. originalHashbangPath)
            return false
        elseif resolvedHashbangProgram == "rom/programs/shell.lua" and #hashbangArgs == 0 then
            ...
            printError("\205\229\235\252\231\255 \232\241\239\238\235\252\231\238\226\224\242\252 shell \234\224\234 \239\240\238\227\240\224\236\236\243 \226 hashbang")
            return false
        end
    ...
    if settings.get("bios.strict_globals", false) then
        getmetatable(env).__newindex = function(_, name)
            error("\207\238\239\251\242\234\224 \241\238\231\228\224\242\252 \227\235\238\225\224\235\252\237\243\254 \239\229\240\229\236\229\237\237\243\254 " .. tostring(name), 2)
        end
    end
...
function shell.execute(command, ...)
    ...
    if sPath ~= nil then
        ...
        printError("\207\240\238\227\240\224\236\236\224 \237\229 \237\224\233\228\229\237\224")
        return false
    end
end
...
function shell.setDir(dir)
    ...
    if not fs.isDir(dir) then
        error("\221\242\238 \237\229 \234\224\242\224\235\238\227", 2)
    end
    sDir = fs.combine(dir, "")
end
