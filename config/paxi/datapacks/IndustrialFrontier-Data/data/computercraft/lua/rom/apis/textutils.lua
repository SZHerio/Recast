...
function slowWrite(text, rate)
    ...
    rate = rate or 20
    if rate < 0 then
        error("\209\234\238\240\238\241\242\252 \228\238\235\230\237\224 \225\251\242\252 \239\238\235\238\230\232\242\229\235\252\237\238\233", 2)
    end
    ...
    return function(_n)
        for _ = 1, _n do
            ...
            if nFreeLines <= 0 then
                ...
                _term.write("\205\224\230\236\232\242\229 \235\254\225\243\254 \234\235\224\226\232\248\243, \247\242\238\225\251 \239\240\238\228\238\235\230\232\242\252")
                os.pullEvent("key")
                _term.clearLine()
                _term.setCursorPos(1, h)
            else
        ...
        if type(t) == "table" then
            for nu, sItem in pairs(t) do
                ...
                if ty ~= "string" and ty ~= "number" then
                    error("\237\229\226\229\240\237\251\233 \224\240\227\243\236\229\237\242 \185" .. n .. "." .. nu .. " (\238\230\232\228\224\235\241\255 \242\232\239 string, \239\238\235\243\247\229\237\238 " .. ty .. ")", 3)
                end
...
local function serialize_impl(t, tracking, indent, opts)
    ...
    if sType == "table" then
        if tracking[t] ~= nil then
            if tracking[t] == false then
                error("\205\229\235\252\231\255 \241\229\240\232\224\235\232\231\238\226\224\242\252 \242\224\225\235\232\246\243 \241 \239\238\226\242\238\240\255\254\249\232\236\232\241\255 \241\241\251\235\234\224\236\232", 0)
            else
                error("\205\229\235\252\231\255 \241\229\240\232\224\235\232\231\238\226\224\242\252 \242\224\225\235\232\246\243 \241 \240\229\234\243\240\241\232\226\237\251\236\232 \241\241\251\235\234\224\236\232", 0)
            end
        end
        tracking[t] = true
    ...
    elseif sType == "boolean" or sType == "nil" then
        ...
        error("\205\229\235\252\231\255 \241\229\240\232\224\235\232\231\238\226\224\242\252 \242\232\239 " .. sType, 0)

    end
end

local function mk_tbl(str, name)
    local msg = "\239\238\239\251\242\234\224 \232\231\236\229\237\232\242\252 textutils." .. name
    return setmetatable({}, {
...
do
    ...
    local function expected(pos, actual, exp)
        if actual == "" then actual = "\234\238\237\229\246 \226\226\238\228\224" else actual = ("%q"):format(actual) end
        error_at(pos, "\205\229\238\230\232\228\224\237\237\238\229 \231\237\224\247\229\237\232\229 %s; \238\230\232\228\224\235\238\241\252 %s.", actual, exp)
    end
    ...
    local function parse_string(str, pos, terminate)
        ...
        while true do
            ...
            if c == "" then error_at(pos, "\205\229\238\230\232\228\224\237\237\251\233 \234\238\237\229\246 \226\226\238\228\224: \238\230\232\228\224\235\224\241\252 '\"'.") end
            if c == terminate then break end

            if c == "\\" then
                -- Handle the various escapes
                c = sub(str, pos + 1, pos + 1)
                if c == "" then error_at(pos, "\205\229\238\230\232\228\224\237\237\251\233 \234\238\237\229\246 \226\226\238\228\224: \238\230\232\228\224\235\224\241\252 escape-\239\238\241\235\229\228\238\226\224\242\229\235\252\237\238\241\242\252.") end

                if c == "u" then
                    local num_str = match(str, "^%x%x%x%x", pos + 2)
                    if not num_str then error_at(pos, "\205\229\228\238\239\243\241\242\232\236\224\255 Unicode-\239\238\241\235\229\228\238\226\224\242\229\235\252\237\238\241\242\252 %q.", sub(str, pos + 2, pos + 5)) end
                    buf[n], n, pos = utf8.char(tonumber(num_str, 16)), n + 1, pos + 6
                else
                    local unesc = escapes[c]
                    if not unesc then error_at(pos + 1, "\205\229\232\231\226\229\241\242\237\251\233 escape-\241\232\236\226\238\235 %q.", c) end
            ...
            elseif c >= " " then
                ...
                error_at(pos + 1, "\205\229\253\234\240\224\237\232\240\238\226\224\237\237\251\233 \239\240\238\225\229\235\252\237\251\233 \241\232\236\226\238\235 %q.", c)
            end
        end
    ...
    local function parse_number(str, pos, opts)
        ...
        if not val then error_at(pos, "\205\229\228\238\239\243\241\242\232\236\238\229 \247\232\241\235\238 %q.", num_str) end
    ...
    local function parse_ident(str, pos)
        ...
        if not last then error_at(pos, "\206\230\232\228\224\235\241\255 \234\235\254\247 \238\225\250\229\234\242\224") end
        return val, last + 1
    end
    ...
    local function decode_impl(str, pos, opts)
        ...
        elseif c == "{" then
            ...
            if c == "" then return error_at(pos, "\205\229\238\230\232\228\224\237\237\251\233 \234\238\237\229\246 \226\226\238\228\224: \238\230\232\228\224\235\224\241\252 '}'.") end
            ...
            while true do
                ...
                else return expected(pos, c, "\234\235\254\247 \238\225\250\229\234\242\224")
                end
                ...
                else return expected(pos, c, "',' \232\235\232 '}'")
                end
        ...
        elseif c == "[" then
            ...
            return arr, pos + 1
        elseif c == "" then error_at(pos, '\205\229\238\230\232\228\224\237\237\251\233 \234\238\237\229\246 \226\226\238\228\224.')
        end

        error_at(pos, "\205\229\238\230\232\228\224\237\237\251\233 \241\232\236\226\238\235 %q.", c)
    end
    ...
    unserialise_json = function(s, options)
        ...
        if not ok then
            if type(res) == "table" and getmetatable(res) == mt then
                return nil, ("\206\248\232\225\234\224 JSON \226 \239\238\231\232\246\232\232 %d: %s"):format(res.pos, res.msg)
            end
        ...
        pos = skip(s, pos)
        if pos <= #s then
            return nil, ("\206\248\232\225\234\224 JSON \226 \239\238\231\232\246\232\232 %d: \237\229\238\230\232\228\224\237\237\251\233 \235\232\248\237\232\233 \241\232\236\226\238\235 %q."):format(pos, sub(s, pos, pos))
        end
        return res
