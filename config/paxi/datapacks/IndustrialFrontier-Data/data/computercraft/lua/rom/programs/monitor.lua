...
if tArgs[1] == "scale" then
    ...
    if peripheral.getType(sName) ~= "monitor" then
        print("\204\238\237\232\242\238\240 \237\229 \237\224\233\228\229\237: " .. sName)
        return
    end

    local nRes = tonumber(tArgs[3])
    if nRes == nil or nRes < 0.5 or nRes > 5 then
        print("\205\229\228\238\239\243\241\242\232\236\251\233 \236\224\241\248\242\224\225: " .. tArgs[3])
        return
    end
...
if sPath == nil then
    print("\207\240\238\227\240\224\236\236\224 \237\229 \237\224\233\228\229\237\224: " .. sProgram)
    return
end

print("\199\224\239\243\241\234 " .. sProgram .. " \237\224 \236\238\237\232\242\238\240\229 " .. sName)
