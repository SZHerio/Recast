...
local function parse_color(color)
    ...
    if color < 1 or color > 0xffff then error("\214\226\229\242 \226\237\229 \228\238\239\243\241\242\232\236\238\227\238 \228\232\224\239\224\231\238\237\224", 3) end
...
function create(parent, nX, nY, nWidth, nHeight, bStartVisible)
    ...
    if parent == term then
        error("\205\229 \240\229\234\238\236\229\237\228\243\229\242\241\255 \232\241\239\238\235\252\231\238\226\224\242\252 term \234\224\234 \240\238\228\232\242\229\235\252\241\234\232\233 \238\225\250\229\234\242 \238\234\237\224; \232\241\239\238\235\252\231\243\233\242\229 term.current()", 2)
    end
    ...
    function window.blit(sText, sTextColor, sBackgroundColor)
        ...
        if #sTextColor ~= #sText or #sBackgroundColor ~= #sText then
            error("\192\240\227\243\236\229\237\242\251 \228\238\235\230\237\251 \232\236\229\242\252 \238\228\232\237\224\234\238\226\243\254 \228\235\232\237\243", 2)
        end
    ...
    function window.getLine(y)
        ...
        if y < 1 or y > nHeight then
            error("\209\242\240\238\234\224 \226\237\229 \228\238\239\243\241\242\232\236\238\227\238 \228\232\224\239\224\231\238\237\224.", 2)
        end
