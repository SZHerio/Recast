...
elseif #tModems == 1 then
    print("\205\224\233\228\229\237 1 \236\238\228\229\236.")
else
    print(#tModems .. " - \237\224\233\228\229\237\238 \236\238\228\229\236\238\226.")
end
...
-- Open channels
print("\207\238\226\242\238\240\229\237\238 \241\238\238\225\249\229\237\232\233: 0.")
                ...
                if type(tMessage) == "table" and tMessage.nMessageID and tMessage.nRecipient and type(tMessage.nRecipient) == "number" then
                    if not tReceivedMessages[tMessage.nMessageID] then
                        ...
                        if nTransmittedMessages == 1 then
                            print(nTransmittedMessages .. " - \241\238\238\225\249\229\237\232\229 \239\238\226\242\238\240\229\237\238.")
                        else
                            print(nTransmittedMessages .. " - \239\238\226\242\238\240\229\237\238 \241\238\238\225\249\229\237\232\233.")
                        end
                    end
                end
            end
