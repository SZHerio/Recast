...
function define(name, options)
    ...
    if options then
        ...
        if options.type and not valid_types[options.type] then
            error(("\205\229\232\231\226\229\241\242\237\251\233 \242\232\239 %q. \206\230\232\228\224\235\241\255 \238\228\232\237 \232\231 \242\232\239\238\226: %s."):format(options.type, table.concat(valid_types, ", ")), 2)
        end
    else
        options = {}
    end
