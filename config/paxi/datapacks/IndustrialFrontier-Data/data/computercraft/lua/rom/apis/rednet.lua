...
function open(modem)
    ...
    if peripheral.getType(modem) ~= "modem" then
        error("\204\238\228\229\236 \237\229 \237\224\233\228\229\237: " .. modem, 2)
    end
...
function host(protocol, hostname)
    ...
    if hostname == "localhost" then
        error("\221\242\238 \232\236\255 \243\231\235\224 \231\224\240\229\231\229\240\226\232\240\238\226\224\237\238", 2)
    end
    if hostnames[protocol] ~= hostname then
        if lookup(protocol, hostname) ~= nil then
            error("\200\236\255 \243\231\235\224 \243\230\229 \232\241\239\238\235\252\231\243\229\242\241\255", 2)
        end
...
function run()
    if started then
        error("rednet \243\230\229 \231\224\239\243\249\229\237", 2)
    end
    started = true
