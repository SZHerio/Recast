...
local mChoices = { "\209\238\245\240\224\237\232\242\252", "\194\251\233\242\232" }

-- The message displayed in the footer bar
local fMessage = "\205\224\230\236\232\242\229 Ctrl \232\235\232 \249\184\235\234\237\232\242\229 \231\228\229\241\252, \247\242\238\225\251 \238\242\234\240\251\242\252 \236\229\237\254"
...
if not term.isColour() then
    print("\210\240\229\225\243\229\242\241\255 \243\235\243\247\248\229\237\237\251\233 \234\238\236\239\252\254\242\229\240")
    return
end
...
local menu_choices = {
    Save = function()
        if bReadOnly then
            fMessage = "\196\238\241\242\243\239 \231\224\239\240\229\249\184\237"
            return false
        end
        local success, err = save(sPath)
        if success then
            fMessage = "\209\238\245\240\224\237\229\237\238 \226 " .. sPath
        else
            if err then
                fMessage = "\205\229 \243\228\224\235\238\241\252 \241\238\245\240\224\237\232\242\252 \226 " .. err
            else
                fMessage = "\205\229 \243\228\224\235\238\241\252 \241\238\245\240\224\237\232\242\252 \226 " .. sPath
            end
        end
        return false
    end,
