...
local function addWall(x, y)
    local obj = tScreen[x][y]
    if obj == nil then
        return error("\205\229\242 \234\235\229\242\234\232: X" .. x .. " Y" .. y)
    end
...
local function loadLevel(nNum)
    sLevelTitle = "\211\240\238\226\229\237\252 " .. nNum
    ...
    if not (fs.exists(sLevelD) or fs.isDir(sLevelD)) then return error("\211\240\238\226\229\237\252 \237\229 \237\224\233\228\229\237: " .. sLevelD) end
         ...
         local ex = tostring(tScreen[x][y].exit)
            if not(ex == "zz" or ex == "nil") then
                ...
                elseif ex == "d" then
                    ...
                    return error("\205\229\228\238\239\243\241\242\232\236\251\233 \246\226\229\242 \226\251\245\238\228\224")
                end
         ...
         local st = tostring(tScreen[x][y].start)
            if not(st == "zz" or st == "nil") then
                ...
                elseif Cr == "d" then
                    ...
                    return error("\205\229\228\238\239\243\241\242\232\236\251\233 \246\226\229\242 \241\242\224\240\242\224")
                end
...
if ok and not sStartLevel then
    ok, err = pcall(function()
        ...
        printCentred(TermH / 2 - 0, "  \194\229\240\241\232\255 \228\235\255 ComputerCraft  ")
        term.setTextColor(colors.yellow)
        printCentred(TermH / 2 + 2, "  \217\184\235\234\237\232\242\229, \247\242\238\225\251 \237\224\247\224\242\252  ")
...
if ok then
    ok, err = pcall(function()
        ...
        term.setTextColor(colors.red)
        if TermW >= 40 then
            printCentred(TermH / 2 - 1, "  \209\239\224\241\232\225\238 \231\224 \232\227\240\243 \226 Redirection  ")
            printCentred(TermH / 2 - 0, "  \194\229\240\241\232\255 \228\235\255 ComputerCraft  ")
            printCentred(TermH / 2 + 2, "  \207\238\235\237\224\255 \226\229\240\241\232\255 \232\227\240\251:  ")
            term.setTextColor(colors.yellow)
            printCentred(TermH / 2 + 3, "  http://www.redirectiongame.com  ")
        else
            printCentred(TermH / 2 - 2, "  \209\239\224\241\232\225\238 \231\224  ")
            printCentred(TermH / 2 - 1, "  \232\227\240\243 \226 Redirection  ")
            printCentred(TermH / 2 - 0, "  \194\229\240\241\232\255 \228\235\255 ComputerCraft  ")
            printCentred(TermH / 2 + 2, "  \207\238\235\237\224\255 \226\229\240\241\232\255 \232\227\240\251:  ")
            term.setTextColor(colors.yellow)
...
if not ok then
    if err == "Terminated" then
        print("\207\238\235\237\224\255 \226\229\240\241\232\255 Redirection:")
