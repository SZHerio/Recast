...
local function encode(str, alt_chars)
    ...
    if alt_chars and #alt_chars ~= 2 then
        error("alt_chars \228\238\235\230\229\237 \241\238\228\229\240\230\224\242\252 \240\238\226\237\238 \228\226\224 \241\232\236\226\238\235\224", 2)
    end
...
local function decode(str, alt_chars)
    ...
    if (len % 4) ~= 0 or not str:find("^[%w%" .. alt_chars:sub(1, 1) .. "%" .. alt_chars:sub(2, 2) .. "]*=?=?$") then
        return nil, "\226\245\238\228\237\251\229 \228\224\237\237\251\229 \237\229 \255\226\235\255\254\242\241\255 \228\238\239\243\241\242\232\236\251\236 base64"
    end
