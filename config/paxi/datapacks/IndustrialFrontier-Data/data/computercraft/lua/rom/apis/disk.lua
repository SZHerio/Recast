...
local function isDrive(name)
    if type(name) ~= "string" then
        error("\237\229\226\229\240\237\251\233 \224\240\227\243\236\229\237\242 #1 (\237\243\230\237\224 \241\242\240\238\234\224, \239\238\235\243\247\229\237 \242\232\239 " .. type(name) .. ")", 3)
    end
