...
local function check_key(options, key, ty, opt)
    ...
    if (value ~= nil or not opt) and valueTy ~= ty then
        error(("\237\229\226\229\240\237\238\229 \239\238\235\229 \171%s\187 (\238\230\232\228\224\235\241\255 \242\232\239 %s, \239\238\235\243\247\229\237 \242\232\239 %s)"):format(key, ty, valueTy), 4)
    end
end
...
local function check_request_options(options, body)
    ...
    if options.method and not methods[options.method] then
        error("\205\229\239\238\228\228\229\240\230\232\226\224\229\236\251\233 \236\229\242\238\228 HTTP", 3)
    end
end
