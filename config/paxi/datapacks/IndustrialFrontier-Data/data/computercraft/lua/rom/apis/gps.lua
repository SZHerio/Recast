...
function locate(_nTimeout, _bDebug)
    ...
    if sModemSide == nil then
        if _bDebug then
            print("\193\229\241\239\240\238\226\238\228\237\238\233 \236\238\228\229\236 \237\229 \239\238\228\234\235\254\247\184\237")
        end
        return nil
    end

    if _bDebug then
        print("\206\239\240\229\228\229\235\229\237\232\229 \234\238\238\240\228\232\237\224\242...")
    end
        ...
        if e == "modem_message" then
            ...
            if sSide == sModemSide and sChannel == CHANNEL_GPS and sReplyChannel == CHANNEL_GPS and nDistance then
                ...
                if type(tMessage) == "table" and #tMessage == 3 and tonumber(tMessage[1]) and tonumber(tMessage[2]) and tonumber(tMessage[3]) then
                    ...
                    if _bDebug then
                        print(tFix.nDistance .. " \225\235. \228\238 " .. tostring(tFix.vPosition))
                    end
    ...
    if pos1 and pos2 then
        if _bDebug then
            print("\202\238\238\240\228\232\237\224\242\251 \237\229\238\228\237\238\231\237\224\247\237\251")
            print("\194\238\231\236\238\230\237\251 \234\238\238\240\228\232\237\224\242\251 " .. pos1.x .. "," .. pos1.y .. "," .. pos1.z .. " \232\235\232 " .. pos2.x .. "," .. pos2.y .. "," .. pos2.z)
        end
        return nil
    elseif pos1 then
        if _bDebug then
            print("\202\238\238\240\228\232\237\224\242\251: " .. pos1.x .. "," .. pos1.y .. "," .. pos1.z)
        end
        return pos1.x, pos1.y, pos1.z
    else
        if _bDebug then
            print("\205\229 \243\228\224\235\238\241\252 \238\239\240\229\228\229\235\232\242\252 \234\238\238\240\228\232\237\224\242\251")
        end
        return nil
    end
end
