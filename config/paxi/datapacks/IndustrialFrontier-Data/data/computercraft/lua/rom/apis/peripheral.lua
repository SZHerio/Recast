...
function getType(peripheral)
    ...
    if type(peripheral) == "string" then -- Peripheral name passed
        ...
        if not mt or mt.__name ~= "peripheral" or type(mt.types) ~= "table" then
            error("\237\229\226\229\240\237\251\233 \224\240\227\243\236\229\237\242 #1 (\242\224\225\235\232\246\224 \237\229 \255\226\235\255\229\242\241\255 \239\229\240\232\244\229\240\232\229\233)", 2)
        end
