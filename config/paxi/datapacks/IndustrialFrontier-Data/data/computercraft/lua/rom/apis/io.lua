...
handleMetatable = {
    ...
    __tostring = function(self)
        if self._closed then
            return "\244\224\233\235 (\231\224\234\240\251\242)"
        else
            local hash = tostring(self._handle):match("table: (%x+)")
            return "\244\224\233\235 (" .. hash .. ")"
        end
    end,
    ...
    __index = {
        ...
        close = function(self)
            if type_of(self) ~= "table" or getmetatable(self) ~= handleMetatable then
                error("\237\229\226\229\240\237\251\233 \224\240\227\243\236\229\237\242 #1 (\238\230\232\228\224\235\241\255 FILE, \239\238\235\243\247\229\237 \242\232\239 " .. type_of(self) .. ")", 2)
            end
            if self._closed then error("\239\238\239\251\242\234\224 \238\225\240\224\242\232\242\252\241\255 \234 \231\224\234\240\251\242\238\236\243 \244\224\233\235\243", 2) end
            ...
            if handle.close then
                ...
                return nil, "\237\229\235\252\231\255 \231\224\234\240\251\242\252 \241\242\224\237\228\224\240\242\237\251\233 \239\238\242\238\234"
            end
        end,
        ...
        *not* automatically closed.
        ...
        lines = function(self, ...)
            ...
            local handle = self._handle
            if not handle.read then return nil, "\244\224\233\235 \237\229\228\238\241\242\243\239\229\237 \228\235\255 \247\242\229\237\232\255" end

            local args = table.pack(...)
            return function()
                if self._closed then error("\244\224\233\235 \243\230\229 \231\224\234\240\251\242", 2) end
        ...
        read = function(self, ...)
            ...
            local handle = self._handle
            if not handle.read and not handle.readLine then return nil, "\244\224\233\235 \237\229 \238\242\234\240\251\242 \228\235\255 \247\242\229\237\232\255" end
            ...
            for i = 1, n do
                ...
                elseif type_of(arg) == "string" then
                    ...
                    elseif format == "n" then
                        ...
                        error("\237\229\226\229\240\237\251\233 \224\240\227\243\236\229\237\242 #" .. i .. " (\237\229\228\238\239\243\241\242\232\236\251\233 \244\238\240\236\224\242)", 2)
                    end
                else
                    error("\237\229\226\229\240\237\251\233 \224\240\227\243\236\229\237\242 #" .. i .. " (\237\243\230\237\224 \241\242\240\238\234\224, \239\238\235\243\247\229\237 \242\232\239 " .. type_of(arg) .. ")", 2)
                end
        ...
        seek = function(self, whence, offset)
            ...
            local handle = self._handle
            if not handle.seek then return nil, "\244\224\233\235 \237\229 \239\238\228\228\229\240\230\232\226\224\229\242 \239\229\240\229\236\229\249\229\237\232\229 \243\234\224\231\224\242\229\235\255" end
        ...
        write = function(self, ...)
            ...
            local handle = self._handle
            if not handle.write then return nil, "\244\224\233\235 \237\229\228\238\241\242\243\239\229\237 \228\235\255 \231\224\239\232\241\232" end
...
function close(file)
    ...
    if type_of(file) ~= "table" or getmetatable(file) ~= handleMetatable then
        error("\237\229\226\229\240\237\251\233 \224\240\227\243\236\229\237\242 #1 (\238\230\232\228\224\235\241\255 FILE, \239\238\235\243\247\229\237 \242\232\239 " .. type_of(file) .. ")", 2)
    end
    return file:close()
end
