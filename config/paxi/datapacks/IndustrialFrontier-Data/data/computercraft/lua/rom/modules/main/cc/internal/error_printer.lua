    ...
    if type(msg) == "string" then
        ...
        local function display_impl(doc)
            ...
            elseif kind == "concat" then
                ...
                error("\205\229\232\231\226\229\241\242\237\251\233 \242\232\239 \228\238\234\243\236\229\237\242\224: " .. kind)
            end
        end
        display_impl(msg)
    end
...
return function(context, message)
    ...
    if #message == 0 then error("\207\243\241\242\238\229 \241\238\238\225\249\229\237\232\229", 2) end
    ...
    for msg_idx = 1, #message do
        ...
        if type(msg) == "table" and msg.tag == "annotate" then
            ...
            pretty.print(code_accent .. pretty.text("\209\242\240\238\234\224 " .. line, colours.cyan))
