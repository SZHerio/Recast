...
local function preload(package)
    return function(name)
        if package.preload[name] then
            ...
            return nil, "\237\229\242 \239\238\235\255 package.preload['" .. name .. "']"
        end
    end
end
    ...
    return function(name, path, sep, rep)
        ...
        for pattern in string.gmatch(path, "[^;]+") do
            ...
            if fs.exists(sPath) and not fs.isDir(sPath) then
                ...
                sError = sError .. "\237\229\242 \244\224\233\235\224 '" .. sPath .. "'"
            end
        end
        return nil, sError
    end
...
local function make_require(package)
    ...
    return function(name)
        ...
        if package.loaded[name] == sentinel then
            error("\246\232\234\235 \232\235\232 \239\240\229\228\251\228\243\249\224\255 \238\248\232\225\234\224 \239\240\232 \231\224\227\240\243\231\234\229 \236\238\228\243\235\255 '" .. name .. "'", 0)
        end
        ...
        local sError = "\236\238\228\243\235\252 '" .. name .. "' \237\229 \237\224\233\228\229\237:"
